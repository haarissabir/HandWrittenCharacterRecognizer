...
public class PaintActivity extends AppCompatActivity implements CanvasAreaView.CanvasController, ColorPickerFragment.ColorPickerListener, SizePickerFragment.SizePickerListener, TouchScreenArt.SavedArtReadListener {
    ...
    private void cropPicture() {
        ...
        String imageSaveTest = MediaStore.Images.Media.insertImage(getContentResolver(),mCanvasView.getDrawingCache(), UUID.randomUUID().toString()+".JPEG", "Drawing");
        if(imageSaveTest != null){
            //CropImage.activity().setGuidelines(CropImageView.Guidelines.ON).start(this);
            //MediaStore.Images.Media.insertImage(getContentResolver(),mCanvasView.getDrawingCache(), UUID.randomUUID().toString()+".png", "Drawing");
